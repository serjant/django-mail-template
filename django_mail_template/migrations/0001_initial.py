    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='A title to identify the mail template.', max_length=100, verbose_name='Title')),
                ...
                ('description', models.TextField(blank=True, help_text='Description of the mail template.', null=True, verbose_name='Description')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Description for configuration. This description can contain the contextual variables that are expected to be used in associated MailTemplates.', null=True, verbose_name='Description')),
